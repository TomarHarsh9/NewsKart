...
// xhr.open('GET', `https://newsapi.org/v2/top-headlines?country=${country}&language=${language}&apiKey=${apiKey}`, true);
xhr.open('GET', `https://newsapi.org/v2/top-headlines?country=in&apiKey=278ad56635644b7bad653eb4657f98bd`, true);
// xhr.open('GET', `https://newsapi.org/v2/top-headlines?country=${country}language=${language}&Pagesize=${pagesize}&apiKey=${apiKey}`, true);
...
const searchButton = documetn.getElementById("search-button");
